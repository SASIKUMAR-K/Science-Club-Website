		...
		<div>
			...
			<div className='aboutClubHomeContainer'>
				...
				<div className='aboutClubHomeDescrip'>
					Welcome to the fascinating world of our Science Club, where curiosity
					meets experimentation, and knowledge is not just acquired but crafted.
					Our club serves as a dynamic platform for inquisitive minds to explore
					the wonders of science through engaging activities, hands-on
					experiments, and insightful discussions.our Science Club is a
					welcoming space for all enthusiasts eager to unravel the mysteries of
					the natural world. Join us on this intellectual journey where
